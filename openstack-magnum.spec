...
PYTHON=%{pyver_bin} stestr-%{pyver} --test-path=./magnum/tests/unit run --concurrency 2
...
%changelog
* Wed Mar 24 2021 RDO <dev@lists.rdoproject.org> 9.4.1-1
- Update to 9.4.1

* Fri Jun 19 2020 RDO <dev@lists.rdoproject.org> 9.4.0-1
- Update to 9.4.0

* Tue Mar 31 2020 RDO <dev@lists.rdoproject.org> 9.3.0-1
- Update to 9.3.0
...
# REMOVEME: error caused by commit https://opendev.org/openstack/magnum/commit/79c7effa39c8ed9a1f48688ee61c5f709d6116af
